...
import { VIETNAM_PROVINCES } from "@/lib/vietnam-destinations";
...
const DESTINATIONS = [
    ...
    ...VIETNAM_PROVINCES.filter(
        (province) => !FEATURED_DESTINATIONS.includes(province),
    ),
];
...
export default function DestinationsCarousel() {
    ...
    const handleLocationClick = (name: string) => {
        const params = new URLSearchParams({ destination: name });
